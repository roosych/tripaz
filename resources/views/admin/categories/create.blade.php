...
<div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="h4 fw-bold mb-0">
            <i class="ph ph-tag me-2" style="color:#dc3545"></i>Добавить категорию
        </h1>
        <p class="text-muted mb-0 small mt-1">Создание новой категории объявлений</p>
    </div>
                ...
                <form method="POST" action="{{ route('admin.categories.store') }}">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-2">
                        ...
                        <button type="submit" class="btn btn-danger">
                            <i class="ph ph-plus-circle me-1"></i>Создать категорию
                        </button>
                    </div>
                </form>
...
<script>
    ...
    if ($('#icon').val()) { $('#icon').trigger('input'); }
</script>
@endsection
